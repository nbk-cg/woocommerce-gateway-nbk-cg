	...
	return (
		<>
			<div className="wc-block-gateway-container wc-inline-card-element">
				<CardElement
					id="wc-nbk-cg-inline-card-element"
				...
				/>
				<label htmlFor="wc-nbk-cg-inline-card-element">
					{ __(
		...
		<div className="wc-block-card-elements">
			...
			<div className="wc-block-gateway-container wc-card-expiry-element">
				<CardExpiryElement
					...
					id="wc-nbk-cg-card-expiry-element"
				/>
				<label htmlFor="wc-nbk-cg-card-expiry-element">
					{ __( 'Expiry Date', 'woocommerce-gateway-nbk-cg' ) }
				</label>
			...
			<div className="wc-block-gateway-container wc-card-cvc-element">
				<CardCvcElement
					...
					id="wc-nbk-cg-card-code-element"
				/>
				<label htmlFor="wc-nbk-cg-card-code-element">
					{ __( 'CVV/CVC', 'woocommerce-gateway-nbk-cg' ) }
				</label>
