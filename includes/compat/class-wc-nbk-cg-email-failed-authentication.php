 ...
 * @extends WC_Email
 */
abstract class WC_Nbk_Cg_Email_Failed_Authentication extends WC_Email {
	/**
	...
	public function get_authorization_url( $order ) {
		return add_query_arg( 'wc-nbk-cg-confirmation', 1, $order->get_checkout_payment_url( false ) );
	}
	...
	public function init_form_fields() {
		...
		$this->form_fields = [
			'enabled'    => [
				'title'   => _x( 'Enable/Disable', 'an email notification', 'woocommerce-gateway-nbk-cg' ),
				'type'    => 'checkbox',
				'label'   => __( 'Enable this email notification', 'woocommerce-gateway-nbk-cg' ),
				'default' => 'yes',
			],
